...
const projects: Project[] = [
  {
    id: 1,
    title: "AI Dashboard",
    description: "A real-time analytics dashboard powered by machine learning, featuring predictive insights and interactive data visualizations.",
  ...
  },
  {
    ...
    description: "Interactive 3D product visualization tool allowing customers to customize products in real-time.",
    techStack: ["Three.js", "React", "WebGL", "GSAP"],
